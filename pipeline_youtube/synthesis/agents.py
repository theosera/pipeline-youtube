...
def call_alpha_batched(
    ...
    *,
    ...
    # Per-future error handling lets every submitted batch finish, but α
    # extraction is all-or-nothing: missing one batch would silently omit
    # entire videos from the downstream MOC/chapters.
