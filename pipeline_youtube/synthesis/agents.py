...
def call_alpha_batched(
    ...
    *,
    ...
    # Collect every future before deciding whether to continue. Continuing
    # with a partial α result would silently remove whole video batches from
    # the downstream β/Leader prompts while reporting synthesis success.
