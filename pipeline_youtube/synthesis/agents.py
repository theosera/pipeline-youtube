...
def call_alpha_batched(
    ...
    *,
    ...
    # Per-future error handling keeps the executor drained before raising.
    # Synthesis is an all-inputs operation: continuing after one α batch
    # fails would silently omit that batch's topics from β/coverage/meta.
