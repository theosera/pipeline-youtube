...
def call_alpha_batched(
    ...
    *,
    ...
    # Per-future error handling: collect every result before deciding
    # whether the stage can continue. α extraction is all-or-nothing:
    # merging only successful batches would silently drop the videos in
    # failed batches from the final synthesis.
