...
def _create_04_md(
    ...
    *,
    ...
    unit_dir: str = "04_Learning_Material",
) -> Path:
    ...
    """
    folder = vault / "Permanent Note" / "08_YouTube学習" / unit_dir / folder_name
...
class TestIsVideoComplete:
    ...
    def test_legacy_unit_dir_still_scanned_when_new_canonical_folder_exists(self, vault):
        """A partial new 04 folder must not hide completed videos in the legacy unit dir."""
        dt = datetime(2026, 4, 16, 9, 14)
        _create_04_md(vault, "2026-04-16-0914 AI駆動経営", _VID_A, "new-folder-video")
        _create_04_md(
            vault,
            "2026-04-16 AI駆動経営",
            _VID_B,
            "legacy-folder-video",
            unit_dir="04_Lerning_Material",
        )
...
class TestGetCompletedVideoIds:
    ...
    def test_collects_ids_across_current_and_legacy_unit_dirs(self, vault):
        dt = datetime(2026, 4, 16, 9, 14)
        _create_04_md(vault, "2026-04-16-0914 AI駆動経営", _VID_A, "動画1")
        _create_04_md(
            vault,
            "2026-04-16 AI駆動経営",
            _VID_B,
