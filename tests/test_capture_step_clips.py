...
the download-use-delete discipline, dry-run, and the never-raise download
degradation.
"""
...
class TestCaptureStepClips:
    ...
    def test_names_are_range_positional_under_subfolder(self, vault: Path):
        ...
        # Delete-after-use: the downloaded working copy must be gone.
        assert not _tmp_video_path(_video()).exists()
