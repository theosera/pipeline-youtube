...
class TestTranscriptResult:
    ...
    def test_hashable(self):
        ...
        # snippets field is a list in the definition; use empty list for hashability test
        r = _make_result()
        # frozen dataclass with list field: list is not hashable so hash should raise
